...
impl AccessControlState {
    ...
    pub(crate) fn enter_function(
        ...
        if new_specifier.is_empty() {
            // We don't allow to call this function, even if in some code paths nothing is accessed.
            // This ensures that static analysis is feasible.
